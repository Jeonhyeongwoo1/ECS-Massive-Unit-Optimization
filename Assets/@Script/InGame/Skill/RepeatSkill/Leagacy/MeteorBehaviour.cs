...
//
//             GameObject shadowPrefab = Manager.I.Resource.Instantiate(Const.MeteorShadow);
//             shadowPrefab.transform.position = destinationPosition;
//             shadowPrefab.SetActive(true);
//             _shadowObject = shadowPrefab;
//             Manager.I.Audio.Play(Sound.Effect, "Meteor_Start");
//         }
//
//         private void Update()
//         {
...
//             GameObject prefab = Manager.I.Resource.Instantiate(hitEffectPrefabName);
...
//         {
//             base.Release();
//             Manager.I.Pool.ReleaseObject(_shadowObject.name, _shadowObject);
