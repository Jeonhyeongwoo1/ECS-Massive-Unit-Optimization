...
//             Manager.I.Audio.Play(Sound.Effect, "PhotonStrike_Start");
//         }
//
//         private void SetTargetMonster(float speed)
//         {
//             _monster = null;
//             var monsterList = Manager.I.Object.GetNearestMonsterList(10);
...
//             _rigidbody.linearVelocity = lerp.normalized * _speed;
//         }
//
//         private void Update()
//         {
