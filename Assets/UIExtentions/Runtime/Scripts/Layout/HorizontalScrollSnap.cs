...
namespace UnityEngine.UI.Extensions
{
    ...
    public class HorizontalScrollSnap : ScrollSnapBase
    {
        ...
        public void AddChild(GameObject GO, Vector2 childSizeDelta)
        {
            AddChild(GO, false, childSizeDelta);
        }
        ...
        public void AddChild(GameObject GO, bool WorldPositionStays, Vector2 childSizeDelta)
        {
            this.childSizeDelta = childSizeDelta;
            _scroll_rect.horizontalNormalizedPosition = 0;
